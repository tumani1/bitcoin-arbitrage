        ...
        for i in range(maxi + 1):
            for j in range(maxj + 1):
                ...
                if profit >= 0 and profit >= best_profit:
                    best_i, best_j = (i, j)
                    best_profit, best_volume = (profit, volume)
    ...
    def tick(self):
        ...
        for kmarket1 in self.depths:
            for kmarket2 in self.depths:
                ...
                if not (market1["asks"] and market2["bids"] and len(market1["asks"]) > 0 and len(market2["bids"]) > 0):
                    continue
