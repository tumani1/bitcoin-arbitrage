...
def fen2yuan(amount, default=100):
    return (decimal.Decimal(amount) / decimal.Decimal(default)).quantize(decimal.Decimal('1E-2'))


def satoshi2btc(amount, default='1E-4'):
    return (decimal.Decimal(amount) / decimal.Decimal(COIN)).quantize(decimal.Decimal(default))
